...
FIELDS=["date","code","name","market","stage","close","a_low","b_neckline","c_low","invalidation","volume_ratio","avg20_lots","avg20_turnover","entry_lower","entry_upper","stop_price","entry_status","entry_fail_reasons","structure_zone_lower","structure_zone_upper","structure_zone_source"]
